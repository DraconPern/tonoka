...
cd %DEVSPACE%
if NOT EXIST boost_1_63_0.zip wget -c http://downloads.sourceforge.net/project/boost/boost/1.63.0/boost_1_63_0.zip
if NOT EXIST boost_1_63_0 unzip -n boost_1_63_0.zip
cd boost_1_63_0
call bootstrap
