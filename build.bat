...
if NOT EXIST boost_1_63_0 unzip -q -o boost_1_63_0.zip
cd boost_1_63_0
call bootstrap
SET COMMONb2Flag=%BOOSTTOOLSET% %BOOSTADDRESSMODEL% asmflags=\safeseh runtime-link=static define=_BIND_TO_CURRENT_VCLIBS_VERSION=1 -j 4 stage
